...
class Register extends React.Component {
	...
	onSubmitRegister = () => {
		fetch('https://salty-escarpment-78059.herokuapp.com/register', {
			method: 'post',
	...
	render() {
		...
		return (
			<article className="mw6 center bg-transparent hover-bg-white br3 pa3 pa4-ns mv3 ba b--black-10 shadow-5">
